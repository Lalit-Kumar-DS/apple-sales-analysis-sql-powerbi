...
> Discount strategy, product condition, and event-driven promotions directly shape revenue, customer sentiment, and pricing decisions.
...
| Area | Business Value |
| --- | --- |
| Pricing Strategy | Better discount and margin decisions |
| Sales Performance | Stronger understanding of event-driven demand |
| Customer Insight | Improved view of rating and engagement trends |
| Decision Support | Actionable dashboards for business stakeholders |
...
This project demonstrates a complete analytics workflow from raw data to business insight, which is directly aligned with modern analytical and BI responsibilities.
...
Improved structure and consistency across pricing, discount, and review fields to support reliable analysis and dashboard reporting.
...
Built a repeatable SQL-based process to convert raw product data into actionable business insights.
...
Measured product performance across pricing, promotions, review behavior, and category-level profitability.
...
The findings help guide more effective discount planning, category-level pricing decisions, and performance monitoring.
...
Converted analysis into a business-friendly dashboard narrative that improves communication and decision-making.

</div>

## 🔗 Related Project Files

- [raw_data](https://github.com/Lalit-Kumar-DS/apple-sales-analysis-sql-powerbi/blob/main/data/raw_data.csv) — raw Apple pricing dataset
- [create_table.sql](https://github.com/Lalit-Kumar-DS/apple-sales-analysis-sql-powerbi/blob/main/scripts/create_table.sql) — schema creation and base table setup
- [import_and_alter.sql](https://github.com/Lalit-Kumar-DS/apple-sales-analysis-sql-powerbi/blob/main/scripts/import_and_alter.sql) — data import and transformation logic
- [analysis_query.sql](https://github.com/Lalit-Kumar-DS/apple-sales-analysis-sql-powerbi/blob/main/scripts/analysis_query.sql) — exploratory and business analysis queries
- [project_of_sql.sql](https://github.com/Lalit-Kumar-DS/apple-sales-analysis-sql-powerbi/blob/main/scripts/project_of_sql.sql) — supporting SQL project work
- [apple_products_pricing_2020_2026.xlsx](https://github.com/Lalit-Kumar-DS/apple-sales-analysis-sql-powerbi/blob/main/dashboard/apple_products_pricing_2020_2026.xlsx) — Excel analysis file
- [project_git.pbix](https://github.com/Lalit-Kumar-DS/apple-sales-analysis-sql-powerbi/blob/main/dashboard/project_git.pbix) — Power BI report file
- [excel_dashboard.JPG](https://github.com/Lalit-Kumar-DS/apple-sales-analysis-sql-powerbi/blob/main/image/excel_dashboard.JPG) — Excel dashboard screenshot
- [power_bi_dashboard.JPG](https://github.com/Lalit-Kumar-DS/apple-sales-analysis-sql-powerbi/blob/main/image/power_bi_dashboard.JPG) — Power BI dashboard screenshot
...
This project is structured to be reproducible and easy to extend for additional pricing and sales analysis.
...
The analysis translates raw numbers into business actions that can improve pricing strategy and campaign effectiveness.
...
SQL • Data Cleaning • KPIs • Business Analysis • Dashboard Storytelling
...
![Profile](https://img.shields.io/badge/Data%20Analyst-BI%20Enthusiast-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)
